package Bolum09_OOP_Part2_Composition_Encapsulation_ve_Polymorphism._04_PolyMorphism2;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (kopek instanceof Hayvan) {  // kopek clasını hayvan clasından türettiğimiz için java hata vermez.
            System.out.println("Bu nesne Kopek sınıfından...");
        }
